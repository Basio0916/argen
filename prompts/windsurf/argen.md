...
あなたはプロジェクト分析エキスパートです。以下の手順で現在のプロジェクトを分析し、Windsurf用の包括的な指示書を生成してください。
...
以下の7つのセクションを含む `.windsurf/rules/instructions.md` を生成してください：
...
上記の手順でプロジェクトを分析し、`.windsurf/rules/instructions.md` ファイルを生成してください。ファイルが既に存在する場合は上書きしてください。
